  ...
  return (
    <div className="space-y-1">
      <p className="text-[#5E5D59]">
        Kerala, India · UTC +5:30
      </p>
      <div className="flex items-center gap-1.5 text-sm text-[#141413] tabular-nums">
        <svg
          width="16"
          height="16"
          viewBox="0 0 24 24"
          ...
          className="w-4 h-4 shrink-0 text-[#141413]"
          aria-hidden="true"
        >
          <path
            opacity="0.4"
        ...
        <span>{time || "--:--:--"}</span>{" "}
        <span className="text-xs text-[#84837E]">IST</span>
      </div>
    </div>
  );
}
