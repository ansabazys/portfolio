    ...
    <section className="flex flex-col  gap-5 h-full justify-center items-center">
      <div>
        <h1 className="text-3xl w-full max-w-lg font-light text-neutral-400">
          <span className="dark:text-white text-black font-sans">Hey, I'm Ansab.</span> I build, create, and tell stories that make products
      ...
      <div className=" w-full max-w-lg flex">
        <button className="dark:bg-neutral-900 bg-neutral-200 w-full p-3">start project</button>
