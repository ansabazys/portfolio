    ...
    <section className="flex flex-col gap-5 h-full justify-center items-center">
      <div>
        <h1 className="text-3xl w-full max-w-lg font-light text-neutral-400">
          <span className="text-white">Hey, I'm Ansab.</span> I build, create, and tell stories that make products
          matter. Based in India, <span className="underline text-white underline-offset-5 decoration-1">Say hello</span>
        </h1>
      </div>
